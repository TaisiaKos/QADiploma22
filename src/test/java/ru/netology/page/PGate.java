...
public class PGate {
    ...
    private static final SelenideElement getFieldMistake = $(byText("Поле обязательно для заполнения"));
    ...
    private final SelenideElement paymentPage = $(byText("Оплата по карте"));
